    ...
    async execute(message, args, client) {
        try {
            ...
            const membersChannel = await guild.channels.create({
                ...
                type: 2, // GUILD_VOICE
                reason: 'Stats channels created by Haruka Protect setup-stats',
            });
            ...
            await message.reply(
                ...
                `Ajoute ces IDs dans ton fichier .env (STATS_VC_MEMBERS_ONLINE et STATS_VC_VOICE_COUNT) pour que Haruka mette à jour automatiquement les noms.`
            );
